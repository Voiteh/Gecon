...
shared class IterableTest() extends JsonIntegration() {
	...
	void shouldConvertStreamToJsonArray() {
		value result = gecon.transform(testData.simpleStream, `JsonArray`);
		assertEquals {
			actual = result;
	...
	void shouldConvertJsonArrayToStream() {
		value result = gecon.transform(testData.simpleJsonArray, `{String|Integer|Null*}`);
		assertEquals {
			actual = result;
	...
	void shouldConvertSequenceToJsonArray() {
		value result = gecon.transform(testData.simpleSequence, `JsonArray`);
		assertEquals {
			actual = result;
			expected = testData.simpleJsonArray;
			compare = checkIterableEquality<JsonArray,Value>;
	...
	void shouldConvertListToJsonArray() {
		value result = gecon.transform(testData.simpleListWithNull, `JsonArray`);
		assertEquals {
			actual = result;
	...
	void shouldConvertJsonArrayToList() {
		value result = gecon.transform(testData.simpleJsonArrayWithNull, `List<String|Integer|Null>`);
		assertEquals {
			actual = result;
	...
	void shouldConvertSetToJsonArray() {
		value result = gecon.transform(testData.simpleSet, `JsonArray`);
		assertEquals {
			actual = result;
			expected = testData.simpleJsonArray;
			compare = checkIterableEquality<JsonArray,Value>;
	...
	void shouldConvertJsonArrayToSet() {
		value result = gecon.transform(testData.simpleJsonArray, `Set<String|Integer>`);
		assertEquals {
			actual = result;
	...
	void shouldConvertArrayToJsonArray() {
		value result = gecon.transform(testData.simpleArrayWithNull, `JsonArray`);
		assertEquals {
			actual = result;
			expected = testData.simpleJsonArrayWithNull;
			compare = checkIterableEquality<JsonArray,Value>;
	...
	void shouldConvertJsonArrayToArray() {
		value result = gecon.transform(testData.simpleJsonArrayWithNull, `Array<String|Integer|Null>`);
		assertEquals {
			actual = result;
	...
	void shouldConvertTupleToJsonArray() {
		value result = gecon.transform(testData.simpleTuple, `JsonArray`);
		assertEquals {
			actual = result;
			expected = testData.simpleJsonArray;
			compare = checkIterableEquality<JsonArray,Value>;
	...
	void shouldConvertJsonArrayToTuple() {
		value result = gecon.transform(testData.simpleJsonArray, `[String, Integer]`);
